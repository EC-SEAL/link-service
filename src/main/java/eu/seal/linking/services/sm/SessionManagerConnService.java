...
public interface SessionManagerConnService
{
    ...
    public Object readVariable(String sessionId, String variableName)
    ...
    public String getSession(String varName, String varValue)
            throws UnrecoverableKeyException, KeyStoreException, FileNotFoundException, NoSuchAlgorithmException, CertificateException, InvalidKeySpecException, IOException;
